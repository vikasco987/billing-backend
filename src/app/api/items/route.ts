    ...
    if (contentType.includes("application/json")) {
      ...
      const item = await prisma.item.create({
        data: {
          ...
          currentStock: data.currentStock ? parseInt(data.currentStock) : data.openingStock ? parseInt(data.openingStock) : null,
        ...
        try {
          ...
          const item = await prisma.item.create({
            data: {
              ...
              sellingPrice: fields.sellingPrice ? parseFloat(fields.sellingPrice) : parseFloat(fields.price),
              price: parseFloat(fields.price),
              ...
              currentStock: fields.currentStock ? parseInt(fields.currentStock) : fields.openingStock ? parseInt(fields.openingStock) : null,
